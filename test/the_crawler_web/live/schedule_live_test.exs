defmodule TheCrawlerWeb.ScheduleLiveTest do
  use TheCrawlerWeb.ConnCase, async: false
  import Phoenix.LiveViewTest

  import Mock

  setup_with_mocks([
    {TheCrawler.SpiderManager, [],
     [
  ...
  test "mount view for pick node", %{conn: conn} do
    ...
    assert TheCrawlerWeb.ScheduleLive = view.module
    assert html =~ "Node"
