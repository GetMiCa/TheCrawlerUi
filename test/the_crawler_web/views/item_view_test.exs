defmodule TheCrawlerWeb.ItemViewTest do
  ...
  describe "render jobs/:job_id/items/index.html" do
    test "shows list items" do
      ...
      %{total_pages: total_page, entries: rows} = TheCrawler.Manager.list_items(job_id)

      params = [job_id: job_id, total_pages: total_page, search: nil, rows: rows, page: 1]

      rendered_string = render_to_string(TheCrawlerWeb.ItemView, "index.html", params)
    ...
    test "with empty search string" do
      ...
      assert render_to_string(TheCrawlerWeb.ItemView, "index.html", params) =~
  ...
  describe "render jobs/:job_id/items/:id/show.html" do
    test "show item data" do
      ...
      rendered_string = render_to_string(TheCrawlerWeb.ItemView, "show.html", params)
  ...
  defp index_params(data, search) do
    ...
    %{total_pages: total_pages, entries: rows} = TheCrawler.Manager.list_items(job_id)
