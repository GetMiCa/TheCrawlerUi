defmodule TheCrawlerWeb.JobViewTest do
  ...
  test "render runtime when job run time is nil" do
    ...
    assert render_to_string(TheCrawlerWeb.JobView, "show.html",
             total_pages: 1,
             live_action: :index,
             page: 1,
             spider: nil,
  ...
  test "render spider name with String input" do
    ...
    view =
      render_to_string(TheCrawlerWeb.JobView, "show.html",
        total_pages: 1,
        live_action: :index,
        page: 1,
        spider: nil,
  ...
  test "render spider name with atom input" do
    view =
      render_to_string(TheCrawlerWeb.JobView, "pick_spider.html",
